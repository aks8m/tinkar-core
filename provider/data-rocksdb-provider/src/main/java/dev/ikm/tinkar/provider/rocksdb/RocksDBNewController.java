...
public class RocksDBNewController extends RocksDBController {

	public static String CONTROLLER_NAME = "New RocksDB Store";
	...
	public boolean isValidDataLocation(String name) {
		return name.toLowerCase().endsWith(".zip") && name.toLowerCase().contains("pb");
